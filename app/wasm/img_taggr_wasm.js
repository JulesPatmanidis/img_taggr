 ...
 * @returns {string}
 */
export function read_meta(bytes, filename) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.read_meta(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {boolean}
 */
export function supported(filename) {
 ...
 * @param {number} lat
 * @param {number} lon
 * @param {boolean} has_gps
 * @param {boolean} clear_gps
 * @returns {Uint8Array}
 */
export function write_meta(bytes, filename, datetime, offset, lat, lon, has_gps, clear_gps) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(filename, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(datetime, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(offset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.write_meta(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, lat, lon, has_gps, clear_gps);
    if (ret[3]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('img_taggr_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
